...
<html class="no-js" lang="es">
    ...
    <body>
                                    ...
                                    <form id="FrmCategoria">
                                        <div class="row">
                                            <div class="form-group col-sm-9 col-12">
                                                <input type="text" id="txtNombreCategoria" name="txtNombreCategoria" class="form-control form-control-sm mt-2" placeholder="NOMBRES Y APELLIDOS">
                                            </div>
                                            <div class="col-sm-2 col-12">
                                                <button type="submit" id="btnBuscarCategoria" class="btn btn-primary btn-xs mt-2 mr-1"><i class="fa fa-search" aria-hidden="true"></i> BUSCAR</button>
                                                <button type="submit" id="btnNuevaCategoria" class="btn btn-primary btn-xs mt-2"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                <table class="table-hover table-bordered col-12">
        ...
        <script src="<%out.print(getServletContext().getContextPath());%>/ssets/js/jquery.slicknav.min.js"></script>
